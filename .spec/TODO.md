...
## 優先度：高（Phase 1 — 既存ドリフト解消）
- [ ] #c docs/shimamura 4本 + SKILL.md 2本 + docs/common/codeceptjs_api_reference.md を現行コードに追従（check_doc_refs の shimamura/common 分がゼロに）

## 優先度：中（Phase 2）
- [ ] #d utils 集約（extractRecordId / BASE_URL / waitForSaveResult / buildTestName）
