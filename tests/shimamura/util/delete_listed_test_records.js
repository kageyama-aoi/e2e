 ...
 * 対象は事前に `list_api_test_contacts.js`（読み取りのみ）で確認すること。
 *
 * 実行例:
...
/**
 * 削除対象。list_api_test_contacts.js（読み取りのみ）で確認した UUID をここに書く。
 * 例: { recordId: 'ccac9d9f-015e-789b-39cb-6ab4dc9d5f17', label: 'API調査0924 一郎' },
...
Scenario('指定した record UUID のレコードを削除する', async ({ I }) => {
  ...
  I.say('【削除】すべて完了。list_api_test_contacts.js で残件を確認すること');
});
