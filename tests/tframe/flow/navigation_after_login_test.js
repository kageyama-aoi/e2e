/**
 * @fileoverview 講師用トークン取得テスト
 * 
 * **テスト内容**
 * - 管理者ログイン後、APIテストページ経由で講師 (TEST_USER_TEACHER) のトークンを取得する
 * - 取得したトークンが正しく変数に格納されるかを確認
 * 
 * **作成日**
 * - 2025-12-20
 * 
...
Scenario('ログイン後にAPIを実行しトークンを抽出する', async ({ I, loginKannrisyaPage, apiCommonLoginPage }) => {
